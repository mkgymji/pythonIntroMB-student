...
\begin{frame}[fragile]{Vlastní melodie — notový zápis}
  ...
  \begin{tabular}{ll}
    ...
    \midrule
    \pyinline{"C4:4"}  & nota C, oktáva 4, čtvrťová \\
    \pyinline{"E4:2"}  & nota E, oktáva 4, půlová \\
...
music.play(melodie)
  ...
  \medskip
  \begin{alertblock}{Pozor — délky fungují opačně!}
    Větší číslo = \textbf{kratší} nota.
    \pyinline{"C4:4"} (čtvrťová) je kratší než \pyinline{"C4:2"} (půlová).\\
    \small Jak pizza: krájená na 4 díly → každý díl je menší než když ji krájíme na 2.
  \end{alertblock}
\end{frame}
