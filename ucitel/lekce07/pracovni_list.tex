...
\medskip\noindent
\pojem{Seznamy} uchovávají více hodnot najednou — prvky jsou číslovány od~0.
Modul \pyinline{music} umožňuje přehrávat melodie jako seznam not.
...
\begin{enumerate}
  ...
  \item Co se stane, pokud stiskneš A a melodie stále hraje?
        Jak bys program upravil, aby melodii přerušil?
\end{enumerate}
...
Vlastní melodii zapíšeme jako seznam řetězců — každá nota má formát \pyinline{"NOTA[OKTAVA]:DELKA"}.
